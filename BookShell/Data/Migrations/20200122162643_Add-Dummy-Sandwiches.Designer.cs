...
namespace BookShell.Data.Migrations
{
    ...
    [Migration("20200122162643_Add-Dummy-Sandwiches")]
    partial class AddDummySandwiches
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookShell.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BookShell.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookShell.Models.Author", b =>
                {
                    b.HasOne("BookShell.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("Authors")
            ...
            modelBuilder.Entity("BookShell.Models.Book", b =>
                {
                    ...
                    b.HasOne("BookShell.Models.Author", "Author")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("BookShell.Models.Comment", b =>
                {
                    ...
                    b.HasOne("BookShell.Models.Book", "Book")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookShell.Models.ApplicationUser", null)
                        .WithMany()
